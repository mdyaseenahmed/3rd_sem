/*****************************************************************************
    C Program To Implement REVERSE of The QUEUE Data Structure.
*****************************************************************************/
...
void reverse()
{
    ...
    {
        for(i = front; i<=rear; i++)    /*PUSHES The Contents of The QUEUE into The STACK.*/
        {
            temp = delet();
            push(temp);
            ++count;
        }                               
        for(i = 0; i < count; i++)     /*POPs the Contents of The STACK & Insert Back Into the QUEUE.*/
        {
            temp = pop();
            Q[++rear] = temp;
        }
